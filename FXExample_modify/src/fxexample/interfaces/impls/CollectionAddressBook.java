...
public class CollectionAddressBook implements AddressBook {
    ...
    public CollectionAddressBook() {       
        // Создать callback extractor и передать его в коллекцию для отслеживния изменений в ссылках персон
        Callback<Person, Observable[]> extractor = (Person person) -> new Observable[] {
            person.fio(), 
            person.phone()
        };

...
public class Example4K extends Application {
    ...
    private static void loadGraphics() {
        left = new Image(getResource("/images/left.png"));
        leftGreen = new Image(getResource("/images/leftG.png"));

        right = new Image(getResource("/images/right.png"));
        rightGreen = new Image(getResource("/images/rightG.png"));
    }
